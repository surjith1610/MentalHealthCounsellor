...
source "amazon-ebs" "my-ami" {
  ...
  ami_name        = "llama_webapp_${formatdate("YYYY_MM_DD_HH_mm_ss", timestamp())}"
  ami_description = "LLAMA Webapp AMI"
...
build {
  ...
  provisioner "file" {
    source      = "../MentalHealthCounsellor.zip"
    destination = "/tmp/MentalHealthCounsellor.zip"
  }
